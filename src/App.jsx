                ...
                <>
                            ...
                            <div className="space-y-10 text-gray-300 text-[15px] md:text-base leading-[2.2] font-light">
                                ...
                                <FadeInSection delay={200}>
                                    <div className="border-l-[1px] border-gray-600 pl-6 mt-20">
                                        ...
                                        <p className="mb-6">生涯最初で最後の群写真作品として「<a href="https://1500.design4qol.com/" target="_blank" rel="noreferrer" className="text-white border-b border-gray-600 hover:text-yellow-500 hover:border-yellow-500 transition duration-300 pb-1">1500 portraits project</a>」を展開中です。<br />「存在の証明」をテーマに活動していこうと思っております。</p>
                    ...
                    {lightboxIndex !== null && (
                        ...
                        >
                            ...
                            <button onClick={(e) => { e.stopPropagation(); setLightboxIndex((prev) => (prev - 1 + displayedPhotos.length) % displayedPhotos.length); }} className="absolute left-4 md:left-8 text-gray-600 hover:text-white p-4 hidden md:block transition-transform hover:-translate-x-2 z-50">
                            ...
                            <button onClick={(e) => { e.stopPropagation(); setLightboxIndex((prev) => (prev + 1) % displayedPhotos.length); }} className="absolute right-4 md:right-8 text-gray-600 hover:text-white p-4 hidden md:block transition-transform hover:translate-x-2 z-50">
