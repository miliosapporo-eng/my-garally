                ...
                <div className="relative z-10 container mx-auto max-w-4xl text-center">
                    ...
                    <div className="space-y-6 text-gray-400 text-base md:text-lg leading-loose font-light text-left">
                        ...
                        <FadeInSection delay={400}>
                            ...
                            <p>
                                僕が撮りたいと思うのは、輝かしい存在が目の前にあった時なのだということが分かりました。そこで、その光輝くものは影を生む。また、同じ一辺倒の明るさの中にいては、それらは輝きを放てないでしょう。少しほの暗い方がいいのかもしれない。或いは、完全な闇の中の方がいいのかもしれない。つまりは、暗闇の中に差し込む一筋の光。それこそが僕の撮っているものなのだ。と、腑に落ちたのでした。僕から見た貴方はそれだけ尊いものなのです。
                            </p>
                        </FadeInSection>
