                ...
                <div className="relative z-10 container mx-auto max-w-3xl">
                    ...
                    <div className="space-y-10 text-gray-300 text-[15px] md:text-base leading-[2.2] font-light">
                        ...
                        <FadeInSection delay={200}>
                            ...
                            <p className="mb-6">この自分自身のブランドを作ろうとした時、僕はどうして、何を、どんな時にレンズを向けてシャッターを切っているのだろう。と過去これまで撮ってきた写真を数々を見返していました。残っている写真はほぼ全て自分自身の動機と感性によって撮られたものだったので、その分析に時間は要しませんでした。</p>
